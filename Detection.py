...
class VideoProcessor:
    ...
    def process_video(self):
        ...
        try:
            while True:
                ...
                for face in faces:
                    ...
                    if angle and area > 600:
                        ...
                        screenshot = frame_copy[y1 - 25:y2 + 25, x1 - 15:x2 + 15].copy()
            ...
            #self.obj_tracker.end_video(group=self.group)
...
if __name__ == "__main__":
    ...
    video_url = '/home/stargroup/new/saved_videos/output_video_2024-03-18_15-44-27.avi'
    group = 'group-1'
